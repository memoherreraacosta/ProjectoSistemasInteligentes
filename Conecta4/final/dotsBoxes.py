...
class Connect4GameController(TwoPlayersGame):

    """ Class that is used to play the TIC TAC TOE game. Now, connect 4"""
...
def main():
    ...
    # Start the game
    os.system('')
    Connect4GameController([Human_Player(clasificador), AI_Player(algorithm)]).play()
